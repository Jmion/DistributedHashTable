...
args_t *parse_opt_args(size_t supported_args, char ***rem_argv){
	...
	//correcteur: les options ne sont pas forcement ordonnées, il faut faire un boucle
	// pour chercher à chaque fois si l'option est -r, -n , -w ou --
	//looking for -n
	...
	//correcteur: gestion des valeurs par default, verification des valeurs ?
